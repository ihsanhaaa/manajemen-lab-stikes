...
class BahanCairKeluarSheet implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell
{
    protected $bulan;
    protected $tahun;
    ...
    {
        // Ambil data bahan keluar dengan filter bahan yang jenis_bahan != 'Padat'
