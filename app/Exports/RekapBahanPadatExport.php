...
class RekapBahanPadatExport implements FromCollection, WithHeadings, WithCustomStartCell, WithEvents
{
    public function collection()
    {
        return Bahan::where('jenis_bahan', 'Padat') // Hanya data jenis_bahan Padat
            ->get()
            ->map(function ($bahan) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Laporan Stok Bahan Padat ' . $bulanTahun);
