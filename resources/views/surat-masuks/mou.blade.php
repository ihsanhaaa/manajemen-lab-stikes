                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Data Surat MOU</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="selection-datatable" class="table dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                @foreach($surat_mous as $key => $surat_masuk)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $surat_masuk->tanggal_mulai }}</td>
                                                        <td>{{ $surat_masuk->tanggal_berakhir }}</td>
                                                        <td>
                                                            @if($surat_masuk->selisih_hari !== null)
                                                                {{ $surat_masuk->selisih_hari }} Hari Lagi
                                                            @else
                                                                -
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            {{-- <a href="{{ route('data-surat-mou.show', $surat_masuk->id) }}" class="btn btn-info btn-sm mx-1"><i class="fas fa-eye"></i> Lihat Detail</a> --}}
                                                        </td>
                                                    </tr>
                                                @endforeach
