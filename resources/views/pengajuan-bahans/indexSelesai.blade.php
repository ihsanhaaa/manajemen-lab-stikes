...
@section('title')
    Pemakaian Obat dan Bahan Selesai
@endsection
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                @role('Ketua STIKes')
                                    <h4 class="mb-sm-0">Data Pengajuan Selesai ({{ $pengajuanbahanSelesais->count() }})</h4>
                                @endrole
                                        ...
                                        <form action="{{ route('pengajuan-bahan.store') }}" method="POST"
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="anggota_kelompok" class="form-label"
                                                            style="font-size: 13px;">Nama Anggota Kelompok<span
                                                                style="color: red;">*</span> </label>
                                                        <input type="text"
                                                            class="form-control @error('anggota_kelompok') is-invalid @enderror"
                                                            id="anggota_kelompok" name="anggota_kelompok"
                                                            placeholder="Contoh: Budi, Adam, Widya"
                                                            value="{{ old('anggota_kelompok') }}" required>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="nim_kelompok" class="form-label"
                                                            style="font-size: 13px;">NIM Ketua Kelompok<span
                                                                style="color: red;">*</span></label>
                                                        <input type="text"
                                                            class="form-control @error('nim_kelompok') is-invalid @enderror"
                                                            id="nim_kelompok" name="nim_kelompok"
                                                            value="{{ old('nim_kelompok') }}" required>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="tanggal_praktikum" class="form-label"
                                                            style="font-size: 13px;">Tanggal Praktikum<span
                                                                style="color: red;">*</span></label>
                                                        <input type="datetime-local"
                                                            class="form-control @error('tanggal_praktikum') is-invalid @enderror"
                                                            id="tanggal_praktikum" name="tanggal_praktikum"
                                                            value="{{ old('tanggal_praktikum') }}" required>
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="font-size: 13px;">Satuan<span
                                                                            style="color: red;">*</span></th>
                                                                    <th style="font-size: 13px;">Jenis<span
                                                                            style="color: red;">*</span></th>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('pengajuan-bahan.index') }}">
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            ...
                                            <div class="tab-pane active" id="pengajuanMahasiswaSelesai" role="tabpanel">
                                                                ...
                                                                <td>
                                                                    <div class="d-flex">
                                                                        @role('Admin Lab')
                                                                            @if ($obat->status == 0)
                                                                                <form
                                                                                    action="{{ route('pengajuan-bahan.konfirmasi.update', $obat->id) }}"
                                                                                    method="post"
                                                                                    onclick="return confirm('Apakah anda yakin ingin mengkonfirmasi ini?')">
                                                                                    @csrf
                                                                                    <button class="btn btn-success btn-sm"><i
                                                                                            class="fas fa-edit"></i> ACC
                                                                                        Sekarang</button>
                                                                                </form>
                                                                            @endif
                                                                        @endrole
