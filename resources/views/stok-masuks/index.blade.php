                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="importModalLabel">Import Data Obat Masuk</h5>
                                        ...
                                        <form action="{{ route('data-obat.import') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="alert alert-primary" role="alert">
                                                    Sebelum melanjutkan, pastikan data excel anda sudah sesuai dengan template yang ditentukan, jika belum silahkan download template excel <a href="{{ asset('template-excel/template-obat-masuk.xls') }}">disini</a>
                                                </div>
